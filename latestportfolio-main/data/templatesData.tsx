  ...
  },
  {
    ...
    demo: () => (
      <div className="w-full h-96 bg-white rounded-lg shadow-lg p-8">
        ...
        <footer className="mt-6 text-center">
          <button className="bg-green-500 text-white px-6 py-3 rounded-lg font-bold">Shop Now</button>
        </footer>
      </div>
    ),
    code: `
...
export const components: MarketplaceItem[] = [
  ...
  },
  {
    ...
    demo: () => (
      <div className="w-full h-40 bg-gray-800 rounded-lg flex items-center justify-center p-4">
        <div className="bg-blue-500 text-white p-4 rounded-lg max-w-xs">Hi there! This is a chat bubble.</div>
      </div>
    ),
    code: `
  function ChatBubble() {
  ...
  },
  {
    ...
    demo: () => (
      <div className="w-full h-64 overflow-hidden relative">
        <img src="https://via.placeholder.com/800x400" className="w-full h-full object-cover" alt="Slide 1" />
      </div>
    ),
    code: `
          ...
          {open && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <button onClick={() => setOpen(false)} className="bg-blue-500 text-white px-4 py-2 rounded">
                  Close
                </button>
              </div>
            </div>
  ...
  },
  {
    ...
    demo: () => (
      <div className="border rounded p-4">
        <img src="https://via.placeholder.com/300" alt="Product" className="w-full h-48 object-cover rounded" />
  ...
  },
  {
    ...
    demo: () => (
      <div className="border rounded p-4 flex items-center space-x-4">
        <img src="https://via.placeholder.com/80" alt="User" className="w-16 h-16 rounded-full" />
        <div>
  ...
  },
  {
    ...
    demo: () => (
      <div className="flex space-x-2">
        <button className="bg-blue-600 text-white px-3 py-2 rounded">Facebook</button>
        <button className="bg-blue-400 text-white px-3 py-2 rounded">Twitter</button>
        <button className="bg-red-600 text-white px-3 py-2 rounded">Pinterest</button>
      </div>
    ),
    code: `
  ...
  },
  {
    ...
    demo: () => (
      <div className="w-full max-w-md mx-auto">
        <div className="border rounded">
          <button className="w-full text-left p-4 font-bold">What is your return policy?</button>
  ...
  },
  {
    ...
    demo: () => (
      <div className="w-full h-64 overflow-hidden relative">
        ...
        >
          <img src="https://via.placeholder.com/800x400" className="w-full object-cover" alt="Slide 1" />
          <img src="https://via.placeholder.com/800x400?text=Slide+2" className="w-full object-cover" alt="Slide 2" />
          <img src="https://via.placeholder.com/800x400?text=Slide+3" className="w-full object-cover" alt="Slide 3" />
        </div>
      </div>
    ),
    code: `
